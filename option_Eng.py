...
if __name__  == "__main__":
    ...
    mc_price, _ = Monte_carlo_vectorized()
    ...
    start_time = time.time()
    anti_price ,anti_paths = Monte_carlo_vectorized()
    ...
    error_red = ((std_error - anti_error)/ std_error) * 100
    print(f"Variance Reduction: {error_red:.1f}%!\n")
